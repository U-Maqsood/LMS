            ...
            <ul class="navbar-nav ml-auto">
                ...
                <li class="nav-item dropdown">
                    ...
                    <div class="dropdown-menu dropdown-menu-lg dropdown-menu-right">
                        ...
                        <a href="{{URL::to('/admin/changepassword')}}" class="dropdown-item">Change My Password</a>
        ...
        $(document).ready(function () {
            ...
            setInterval(function () {
                ...
                $.ajax({
                    ...
                    url: "{{url('admin/checkActiveSession')}}",
                    method: "get",
...
@php
$id = session()->get("online_user")->id;
@endphp
@if (session("online_user")->usertype == 2 || session("online_user")->usertype == 3) --}}
