...
@section("page_title","Register New Admin")
@section("page_name","Register New Admin")
@section("breadcrumbs")
...
<div class="row">
    <div class="col-12">
        ...
        <form action="{{ url('admin/user_management/create') }}" method="post" enctype="multipart/form-data">
            <div class="mb-3">
            ...
            <div class="row">
                <div class="col-md-2">
                    <button type="submit" class="btn btn-success btn-block"><i
                            class="fas fa-sign-in-alt mr-2"></i>Create</button>
                </div>
            </div>
        </form>
    </div>
