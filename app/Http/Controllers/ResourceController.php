...
class ResourceController extends Controller
{
    public function list($course_id){
        ...
        return view("admin.courses.resources.list",compact('resources','course')); 
    ...
    public function createIndex($course_id){
        ...
        $course = Course::where('id',$course_id)->first();
        return view('admin.courses.resources.create',compact('course'));
    }
    ...
    public function create(Request $req,$course_id){
        ...
        return redirect('admin/courses/resources/'.$course_id)->with('success','Resource has been added');  
    ...
    public function editIndex($course_id,$id){
        ...
        $course = Course::where('id',$course_id)->first();
        return view('admin.courses.resources.edit',compact('course','resource'));
    ...
    public function edit(Request $req,$course_id,$id){
        ...
        return redirect('admin/courses/resources/'.$course_id)->with('success','Resource has been updated');  
    ...
    public function delete($course_id,$id){
        ...
        return redirect('admin/courses/resources/'.$course_id)->with('success','Resource has been deleted');
